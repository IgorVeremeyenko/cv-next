...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center p-2 content-between relative">
      ...
      <div className="text-6xl font-black uppercase font-roboto p-10 flex flex-row gap-4 z-10"><p>about</p> <p className="text-myYellow">me</p></div>
      ...
      <div className="flex flex-row m-20">
        <div className="flex flex-col">
          ...
          <div className="md:container md:mx-auto grid xl:grid-cols-2 p-5 gap-7 md:grid-cols-1">
            ...
            <div className="flex gap-1">
              <h2>Phone:</h2>
              <Link href="tel:+4916092427733" className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-myYellow duration-300 rounded-md pl-2 pr-2">
                <p>+49 160 9242 7733</p>
              </Link>
            </div>
            <div className="flex gap-1">
              <h2>Email:</h2>
              <Link href="mailto:i.veremiienko@gmail.com" target="_blank" className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-myYellow duration-300 rounded-md pl-2 pr-2">
            ...
            <div className="flex gap-1">
              ...
              <Link
                ...
                className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-myYellow duration-300 rounded-md pl-2 pr-2"
              >
